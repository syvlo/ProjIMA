#ifndef TV_L0_DECOMPOSITION_MINIMIZER_ONE_BV_SEVERAL_S_HH_
# define TV_L0_DECOMPOSITION_MINIMIZER_ONE_BV_SEVERAL_S_HH_

/**
 * \file TVL0DecompositionMinimizerOneBVSeveralS.hh
...
/**
 * \class TVL0DecompositionMinimizerOneBVSeveralS
...
public:
     ...
     */
    TVL0DecompositionMinimizerOneBVSeveralS(const std::vector<unsigned>& alpha);
     ...
     */
    TVL0DecompositionMinimizerOneBVSeveralS(const std::vector<unsigned>& alpha, double BetaBV, double BetaS);

    /**
     * \brief		Destructor.
     * \details		Will destroy the output images.
     */
    ~TVL0DecompositionMinimizerOneBVSeveralS();
...
#include "TVL0DecompositionMinimizerOneBVSeveralS.hxx"

#endif /* !TV_L0_DECOMPOSITION_MINIMIZER_ONE_BV_SEVERAL_S_HH_ */
